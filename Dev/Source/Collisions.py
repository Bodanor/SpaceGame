...
class SpaceCollisions():
    ...
    # Fonction permettant de calculer la distance entre deux entité

    def distance_objets(self,objet1, HAUTEUR_OBJET1, LARGEUR_OBJET1, objet2, HAUTEUR_OBJET2, LARGEUR_OBJET2):
        centre_objet1_x = objet1.position()[0] + LARGEUR_OBJET1 / 2
        centre_objet1_y = objet1.position()[1] + HAUTEUR_OBJET1 / 2
        centre_objet2_x = objet2.position()[0] + LARGEUR_OBJET2 / 2
        centre_objet2_y = objet2.position()[1] + HAUTEUR_OBJET2 / 2
        distance = math.sqrt((centre_objet1_x - centre_objet2_x) ** 2 + (centre_objet1_y - centre_objet2_y) ** 2)

        return distance

    def collision_entite(self):

        # Test si les collisions sont activées

        if self.SpaceGameplay.collision_active == True:

            for bonus in BONUS_EN_LISTE:

                distance_vaisseau_bonus = distance_objets(vaisseau, VAISSEAU_LARGEUR, VAISSEAU_HAUTEUR, bonus,
                                                          BONUS_TAILLE,
                                                          BONUS_TAILLE)
            ...
            for planete in PLANETE_EN_LISTE:
                ...
                distance_vaisseau_planete = distance_objets(vaisseau, VAISSEAU_HAUTEUR, VAISSEAU_LARGEUR, planete,
                                                            TAILLE_PLANETE, TAILLE_PLANETE)
                ...
                for missiles in missile:
                    distance_missile_planete = distance_objets(missiles, 10, 10, planete, TAILLE_PLANETE,
                                                               TAILLE_PLANETE)
                ...
                for missile_ufo in MISSILE_UFO_EN_LISTE:
                    distance_missileUFO_planete = distance_objets(missile_ufo, 10, 10, planete, TAILLE_PLANETE,
                                                                  TAILLE_PLANETE)
            ...
            for ufo in UFO_EN_LISTE:
                ...
                distance_vaisseau_UFO = distance_objets(vaisseau, VAISSEAU_LARGEUR, VAISSEAU_HAUTEUR, ufo, UFO_TAILLE,
                                                        UFO_TAILLE)
            ...
            for trou_noir in TROU_NOIR_EN_LISTE:
                ...
                distance_vaisseau_trou_noir = distance_objets(trou_noir, TROU_NOIR_TAILLE, TROU_NOIR_TAILLE, vaisseau,
                                                              VAISSEAU_LARGEUR, VAISSEAU_HAUTEUR)
            ...
            for missile_ufo in MISSILE_UFO_EN_LISTE:
                ...
                distance_missileUFO_vaisseau = distance_objets(vaisseau, VAISSEAU_HAUTEUR, VAISSEAU_LARGEUR,
                                                               missile_ufo, 10, 10)
